...
const ResipeDetailsScreen = () => {
  ...
  //   console.log(`${API_URL}/favorites/${userId}`);
  useEffect(() => {
    const checkIfSaved = async () => {
      try {
        ...
        console.error("Error Recipe is saved:", error.message);
      }
    };
    ...
    const loadRecipeDetail = async () => {
      ...
      try {
        ...
        console.error("Error loading recipe detail:", error.message);
      } finally {
        setLoading(false);
      }
    };
...
export default ResipeDetailsScreen;
